...
def num():
    ...
    while a != 0:
        ...
        if guess == 0:
            ...
            print("Well look at the big brain on", name, "!")
...
name = input("Welcome to the guessing game! Please enter your name: ") 
print("Try to guess what number is selected between 1-9.")
num()
